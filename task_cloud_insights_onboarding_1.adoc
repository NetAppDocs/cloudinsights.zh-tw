...
[role="lead"]
在開始使用 Cloud Insights 之前、您必須先註冊 * NetApp BlueXP* 入口網站。如果您已經登入 BlueXP 、您可以透過幾個快速步驟、開始免費試用 Cloud Insights 。
...
若要登出Cloud Insights 此功能、請按一下您的*使用者名稱*、然後選取*登出*。您將被帶回 link:https://docs.netapp.com/us-en/bluexp-setup-admin/task-logging-in.html["BlueXP 登入"] 畫面。
