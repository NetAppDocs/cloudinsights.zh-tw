...
* 效能的存取驗證：在擷取裝置的網頁瀏覽器中、前往_https：//fors5989/ecomconfig_<SMI-S Hostname or IP> 、其中「SMI-S主機名稱或IP」是SMI-S伺服器的IP位址或主機名稱。此URL適用於EMC SMI-S（又稱為「ECOM」）服務的管理入口網站、您將會收到登入快顯視窗。
