...
....
如需詳細資訊、請參閱 <<concept_cs_integration_with_ontap_arp.html,整合ONTAP 了功能完善的勒索軟體保護功能>>
...
----
如需詳細資訊、請參閱 <<concept_ws_integration_with_ontap_access_denied.html,與 ONTAP 存取整合遭拒>>
