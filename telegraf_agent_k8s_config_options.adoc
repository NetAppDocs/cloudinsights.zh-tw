...
|  | skipLockedMemory | 請參閱 link:https://community.influxdata.com/t/updating-telegraf-to-version-1-29-5-crashes-kubernetes-pod/33376["已知的 Telegraf 問題"]。  設定 skipLockedMemory 會指示 Kubernetes 監控操作員使用執行 Telegraf `--unprotected` 旗標。 
